    ...
    return (
        ...
        <>
            ...
            </label>
            {
                showButtons ?
                    <div id={buttonClass}>
                        <button className="fileLoader-button fileLoader-deleteButton"
                                onClick={() => onDeletePress()}>Delete
                        </button>
                        <button className="fileLoader-button fileLoader-checkButton"
                                onClick={() => onCheckPress()}>Check
                        </button>
                    </div>
                    : <></>
            }
