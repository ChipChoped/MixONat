...
import "../styles/MoleculeStructure.scss";
...
class MoleculeStructure extends Component {
  static propTypes = {
    ...
    Uint8Array : PropTypes.object.isRequired,
  ...
  drawSVGorCanvas() {
    const mol = window.RDKit.get_mol_from_uint8array(this.props.Uint8Array || "invalid");
